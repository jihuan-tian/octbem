function L2_error = CalcL2ErrorS2(dofs, functor, ansatz_function_space, shape_functions_for_geometry, cell_indices_for_integration, mesh_obj, quad_order, sphere_center, sphere_radius)
  ## CalcL2ErrorS2 - Calculate the L2-error between a grid function and
  ...
  functor_L2_norm = CalcL2NormS2ForExpr(functor, shape_functions_for_geometry, cell_indices_for_integration, mesh_obj, quad_order, sphere_center, sphere_radius);
