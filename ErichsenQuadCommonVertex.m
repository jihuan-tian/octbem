function ret = ErichsenQuadCommonVertex(kernel_function, norder_for_eta,
  ...
  ## ErichsenQuadCommonVertex - Perform the common vertex integration using the method in
