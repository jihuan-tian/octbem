function cell_neighboring_type = GetQuadNeighboringType(kx_cell_index, ky_cell_index, mesh_cells)
  ## GetQuadNeighboringType - Get the neighboring type between two cells,
