function permutated_node_indices = GenPermutatedQuadNodeIndicesBackward(corner_node_no_to_start, std_quad_node_indices)
  ## GenPermutatedQuadNodeIndicesBackward - Generate the permutated indices for
  ## the list of nodes in a quadrangle cell in backward zigzag direction by
