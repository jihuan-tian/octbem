function neighboring_type_matrix = CalcTriaPanelNeighboringTypes(mesh_cells)
  ## CalcTriaPanelNeighboringTypes - Determine the neighboring type of each pair of panels.
