function L1_error = CalcL1ErrorS2(dofs, functor, ansatz_function_space, shape_functions_for_geometry, cell_indices_for_integration, mesh_obj, quad_order, sphere_center, sphere_radius)
  ## CalcL1ErrorS2 - Calculate the L1-error between a grid function and
  ...
  functor_L1_norm = CalcL1NormS2ForExpr(functor, shape_functions_for_geometry, cell_indices_for_integration, mesh_obj, quad_order, sphere_center, sphere_radius);
