function L1_error = CalcL1ErrorOnQuad(dofs, functor, ansatz_function_space,
				      shape_functions_for_geometry,
				      cell_indices_for_integration, mesh_obj,
				      qpts, qwts)
  ## CalcL1ErrorOnQuad - Calculate the L1-error between a grid function and
  ## an analytical expression for quadrangle mesh.
  ...
  functor_L1_norm = CalcL1NormForExprOnQuad(functor, shape_functions_for_geometry, cell_indices_for_integration, mesh_obj, qpts, qwts);
