function ret = ErichsenQuadSamePanelFlat(kernel_function, norder_for_eta,
					 ...
					 nx, ny,
					 Jx, Jy)
  ## ErichsenQuadSamePanelFlat - Perform the same panel integration using the method in
  ...
  ## first, then to the master cell and will further be pulled back onto
  ## the parameter space \f$(\omega, \eta)\f$ for the numerical
  ...
  ## @param norder_for_omega The number of quadrature points for \f$\omega\f$ on \f$T_{d_3}\f$.
