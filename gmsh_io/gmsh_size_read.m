function [ node_num, node_dim, element_num, number_of_nodes_in_cell ] = ...
...
%
%    Output, integer number_of_nodes_in_cell, the number nodes in the elements.
%
  r8_big = 1.0E+30;
  ...
  while ( 1 )
    ...
    elseif ( level == 2 )
      ...
      if ( s_begin ( text, '$EndElements' ) )
        ...
        [ value, count ] = sscanf ( text, '%d' );
        number_of_nodes_in_cell = count - 5;
        break
      end
    end
