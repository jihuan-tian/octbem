function L2_norm = CalcL2Norm(dofs, ansatz_function_space, cell_indices_for_integration, mesh_obj, quad_order)
  ## CalcL2Norm - Calculate the L2-norm of the given DOFs on the grid.
