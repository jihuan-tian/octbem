function ret = ErichsenQuadCommonVertexFlat(kernel_function, norder_for_eta,
					    ...
					    nx, ny,
					    Jx, Jy)
  ## ErichsenQuadCommonVertexFlat - Perform the common vertex integration using the method in
